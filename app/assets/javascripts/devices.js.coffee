...
#There is a extra js "device_prams_box.js" file complete in jQuery,it does the same. cant tell whats is better, less files or extra js file for special function.
...
$(document).on 'page:change', ->
  ...
  ###This function creates the arrows and trees looking lines before each path name. Im working on get max and not hardcode the lines steps###
